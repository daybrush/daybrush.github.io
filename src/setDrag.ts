...
interface DragOptions {
  ...
  dragstart?: (options: {datas: ObjectInterface<any>}) => any;
  drag?: (options: {datas: ObjectInterface<any>, deltaX: number, deltaY: number}) => any;
  dragend?: (options: {datas: ObjectInterface<any>}) => any;
}
